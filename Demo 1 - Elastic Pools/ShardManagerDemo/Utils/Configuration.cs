...
namespace ShardManagerDemo.Utils
{
    ...
    internal static class Configuration
    {
        ...
        /// </summary>
        public static string ShardMapManagerDatabaseName => "ElasticPools_ShardMapManagerDb";
        ...
        public static string ElasticPoolName => ConfigurationManager.AppSettings["ElasticPool"];
